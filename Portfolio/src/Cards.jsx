...
export default function Cards(prpos){
    ...
    return(
        <div className=" w-full flex flex-row justify-center gap-2 lg:items-center lg:w-2/3" >
                <div className="w-1/12 pt-32 md:pt-44 lg:h-[300px] lg:w-1/3 lg:pt-0 lg:rounded-[20px_20px_20px_20px] ">
                ...
                <div className="bg-black w-10/12 h-72  md:h-[400px] md:w-2/4 lg:h-[350px] lg:w-1/3 rounded-[20px] flex flex-col gap-0">
                ...
                <div className="w-1/12 pt-32  md:pt-44 pl-2 md:pl-4 lg:pt-0 lg:pl-0 lg:w-1/3 lg:rounded-[20px_20px_20px_20px] lg:h-[300px] lg:pr-0">
